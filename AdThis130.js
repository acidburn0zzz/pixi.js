...
if (!window._ate) {
    (function() {
        ...
        var ua = navigator.userAgent.toLowerCase(), d = document, w = window, _6 = window.addthis || {}, A = _6, dl = d.location, b = {win: /windows/.test(ua),xp: (/windows nt 5.1/.test(ua)) || (/windows nt 5.2/.test(ua)),osx: /os x/.test(ua),chb: /chrome/.test(ua) && parseInt((/chrome\/(.+?)\./.exec(ua)).pop(), 10) > 13,chr: /chrome/.test(ua) && !(/rockmelt/.test(ua)),cho: /chrome\/(1[2345678]|2\d)/.test(ua),iph: /iphone/.test(ua) || (/ipod/.test(ua)),dro: /android/.test(ua),wph: /windows phone/.test(ua),ipa: /ipad/.test(ua),saf: /safari/.test(ua) && !(/chrome/.test(ua)),opr: /opera/.test(ua),ffx: /firefox/.test(ua),ff2: /firefox\/2/.test(ua),ffn: /firefox\/((3.[6789][0-9a-z]*)|(4.[0-9a-z]*))/.test(ua),ie6: /msie 6.0/.test(ua),ie7: /msie 7.0/.test(ua),ie8: /msie 8.0/.test(ua),ie9: /msie 9.0/.test(ua),ie10: /msie 10.0/.test(ua),ie11: /trident\/7.0/.test(ua),msi: (/msie/.test(ua)) && !(/opera/.test(ua)),mob: /(iphone|ipod|ipad|android|mobi|blackberry|opera mini|silk)/.test(ua),mod: -1}, _a = {rev: "127626",bro: b,wlp: (l || {}).protocol,dl: dl,unj: w.JSON && typeof w.JSON.parse == "function" && typeof w.JSON.stringify == "function",upm: !!w.postMessage && ("" + w.postMessage).toLowerCase().indexOf("[native code]") !== -1,uls: (function() {
                try {
                    var _b = "addthis-test", _c = window.localStorage;
                    _c.setItem(_b, "1");
                    _c.removeItem(_b);
                    return _c != null;
                } catch (error) {
            ...
            }()),bamp: _atc.bamp - Math.random(),abmp: _atc.abmp - Math.random(),camp: _atc.camp - Math.random(),damp: _atc.damp - Math.random(),cscs: _atc.cscs - Math.random(),sfmp: _atc.sfmp - Math.random(),xamp: _atc.xamp - Math.random(),vamp: _atc.vamp - Math.random(),tamp: _atc.tamp - Math.random(),pamp: _atc.pamp - Math.random(),ab: "-",inst: 1,wait: 500,tmo: null,sub: !!window.at_sub,dbm: 0,uid: null,api: {},imgz: [],hash: window.location.hash};
        ...
        var _1c = function(_1d, _1e) {
        ...
        }, _2a = Array.prototype.map, map = function(obj, _2d, _2e) {
            var _2f = [];
            if (obj == null) {
                return _2f;
            }
            ...
            return a;
        }, _38 = Array.prototype.slice, _39 = function(a) {
            ...
            return reduce((q || "").split(del || "&"), function(acc, _5b) {
                try {
                    var kv = _5b.split((eq || "=")), k = _3b(_duc(kv[0])), v = _3b(_duc(kv.slice(1).join(eq || "=")));
            ...
            return reduce((q || "").split(del || "&"), function(acc, _63) {
                try {
                    var kv = _63.split("="), k = _3b(_duc(kv[0])), v = _3b(_duc(kv.slice(1).join("=")));
                    if (k) {
                        acc[k] = v;
                    }
                } catch (e) {
            ...
            var _6c = _39(arguments, 0), fn = _6c.shift(), _6e = _6c.shift();
            return function() {
            ...
            if (url.search(/(?:^\.\/|^\.\.\/)/) !== -1) {
                _86 = /\.\.\//g;
                var _88 = (url.search(_86) === 0 && url.match(_86).length) || 1, loc = window.location.href.replace(/\/$/, "").split("/");
                            ...
                            if (typeof _98 === "string" && _96.indexOf(".") < 0 && (_96.indexOf("#") < 0 || _96.length === 1) && !_9b(_96.toLowerCase())) {
                                if (_96 === "html") {
                                    ...
                                    if (_96 === "style" && (_a.bro.ie6 || _a.bro.ie7 || (_a.bro.msi && d.compatMode.toLowerCase() === "backcompat"))) {
                                        var _9f = _98.split(";"), x = -1, _a1, _a2, _a3;
                                        while (++x < _9f.length) {
                                            _a1 = _9f[x];
            ...
            return str.join("&");
        }, _ab = {unqconcat: _33,reduce: reduce,slice: _39,strip: _3b,extend: _41,toKV: _50,toJSON: _3d,fromJSON: _3f,rtoKV: _49,fromKV: _5f,rfromKV: _56,otoCSV: _67,bind: _6b,listen: _74,each: _1c,map: map,unlisten: _78,gUD: _7c,gUQS: _7e,clone: _80,mrg: mrg,rel2abs: _84,json2html: _8a,isEmptyObj: _a4,serialize: _a7,misc: {}};
        _a.util = _ab;
        _41(_a, _ab);
        var u = _a.util;
        (function(j, l, m) {
            ...
            function d(s, t) {
                var u = this.getQueue(s), r = typeof u === "string" ? u.indexOf(t) : -1;
                if (r !== -1) {
                    u.splice(r, 1);
                }
            }
        ...
        var _d1 = {isBound: 0,isReady: 0,readyList: [],onReady: function() {
                if (!_d1.isReady) {
                    _d1.isReady = 1;
        ...
        (function(b, d, c) {
            ...
            b.rsu = function() {
                var j = document, h = j.title, e = j.location || {}, g = e.href, f = g.split("#"), i = f.pop();
                if (_a.track.ich(i)) {
                    g = f.join("#");
                }
        ...
        (function(g, j, k) {
            var c = w.console, n = 0, o = 1, a = (!c || typeof c.log === "undefined"), p = n, b = Array.prototype.slice, f = ["error", "warn", "info", "debug"], h = f.length;
            function d() {
                if (p && _a.bro.ie6) {
            ...
            while (--h >= 0) {
                (function(e, q) {
                    g.log[q] = a ? function() {
                        ...
                        var s = b.call(arguments), r = ((((arguments || {}).callee || {}).caller || {}).name), i = typeof c[q] === "function" ? c[q] : c.log;
                        if (r) {
                            s.unshift(r + ": ");
                        }
                        s.unshift("[" + q + "]");
        ...
        (function(c, f, d) {
            var b = new Date(), e = "__at", h = "|", a = "/";
            function g(o, n) {
                var j = this, m = 0, l = 0, i = !!n, k = (i ? e : "") + o;
                keys = {};
        ...
        (function(d, q, s) {
            ...
            d.cookie = d.cookie || {};
            d.cookie.view = {_sd: a,_inc: g,_name: m,reset: v,update: h,get: t,cla: o,toKV: j};
        })(_a, _a.api, _a);
        (function(e, u, v) {
            var g, n = {high: 4,med: 2}, m = (document.location.href.indexOf("addthis.com") > -1), p = 10, h = 20, o = (!m ? "__at" : "") + "ssc", s = {}, c = false, q = [], b = 0, d, x = 0;
            function y() {
        ...
        (function(c, f, e) {
            ...
            function a(j) {
                ...
                var s = j.id || j.name || j.className, l = new Date();
                if (!h[s] || (l.getTime() > h[s].getTime() + 3000)) {
                    h[s] = l;
                } else {
                    return g[s];
                }
                var q = j.offsetTop, k = j.offsetLeft, i = j.offsetWidth, t = j.offsetHeight, n = w.pageYOffset ? w.pageYOffset : d.documentElement.scrollTop, o = w.pageXOffset ? w.pageXOffset : d.documentElement.scrollLeft, m = window.innerHeight || document.documentElement.clientHeight, r = window.innerWidth || document.documentElement.clientWidth, p = 0;
        ...
        (function(d, e, f) {
            ...
            function k(q) {
                var n = (q || {}).childNodes, p, m = q.textContent || q.innerText || "", o = /^\s*$/;
                if (!m) {
                    if (!n) {
                        return "";
                    }
            ...
            function g(m, x, v, t, w) {
                x = x.toUpperCase();
                var u = document, r = (m == body && a[x] ? a[x] : (m || body || u.body).getElementsByTagName(x)), q = [], s, p;
                if (m == body) {
                    a[x] = r;
                }
                if (w) {
            ...
            function b(r, v, s) {
                ...
                var n = (document.getElementsByClassName ? function(x, w) {
                    ...
                    return [];
                })), m = n(r, s), u = (v) ? new RegExp("\\b" + v + "\\b", "i") : null, o = [], q;
        ...
        _6.tip = function(e) {
            ...
            var b = _a.util.json2html({"div.addthis.tip": [{"div.tip-point": ""}, {"div.tip-body": {p: e.text}}]});
        ...
        (function(a, c, b) {
            ...
            _a.extend(a.ad, {type: {NOOP: -1,CLICK: 50,VIEW: 100,POP: 200,COPY: 250,SHARE: 300,FOLLOW: 350,COMMENT: 375,UID: 1000,CUSTOM: 2000}});
        })(_a, _a.api, _a);
        (function(c, e, h) {
            var f = "_ati", i = "_at.";
            c.data = c.data || {};
            c.data.storage = {all: g,clear: n,add: o,get: a,remove: d,exists: k,preRemove: l};
            var m = b();
            function b() {
                if (!_a.uls) {
                    return false;
            ...
            function j(p) {
                ...
                _a.util.each(window.localStorage, function(s) {
                    var r = window.localStorage.key(s), q = window.localStorage.getItem(r);
                    p(r, q);
                });
            }
            function g(p) {
        ...
        (function(c, e, h) {
            ...
            function g(p, q, u, j) {
                ...
                this.m = p;
                this.k = q;
                var l = Math.ceil(p / 32), s = -1;
                if (a) {
                    var w = 1 << Math.ceil(Math.log(Math.ceil(Math.log(p) / Math.LN2 / 8)) / Math.LN2), t = w === 1 ? Uint8Array : w === 2 ? Uint16Array : Uint32Array, r = new ArrayBuffer(w * q), o = this.buckets = new Int32Array(l);
                    if (v) {
                        while (++s < l) {
                            o[s] = v[s];
                        }
                ...
                this.locations = function(C) {
                    var B = this.k, z = this.m, E = this._locations, A = d(C), y = b(A), D = -1, n = A % z;
                    while (++D < B) {
                        E[D] = n < 0 ? (n + z) : n;
                        n = (n + y) % z;
                    }
                ...
                this.add = function(x) {
                    var m = this.locations(x + ""), y = -1, n = this.k, z = this.buckets;
                    while (++y < n) {
                        z[Math.floor(m[y] / 32)] |= 1 << (m[y] % 32);
                    }
                };
                this.test = function(y) {
                    var n = this.locations(y + ""), z = -1, x = this.k, m, A = this.buckets;
                    while (++z < x) {
                        m = n[z];
            ...
            function d(k) {
                var p = k.length, j = 2166136261, o, m, l = -1;
                while (++l < p) {
                    o = k.charCodeAt(l);
                    if (m = o & 4278190080) {
                        j ^= m >> 24;
        ...
        (function(d, f, h) {
            var g = d.data.bloom.filter, l = d.data.storage, j = 3, k = "hbs", c = 600, e = 2;
            ...
            function i(m, o, p) {
                ...
                this.prune = function(w) {
                    l.remove(this.name);
                    var x = this.getCurrentBlooms(), w = Math.min(w || j, 31), s = [], v = n(this.generateName()), t = v.m, u = v.d;
                ...
                this.testAll = function(t) {
                    var v = false;
                    if (!q) {
                        var u = this.getCurrentBlooms(), s = this;
            ...
            function a(o) {
                var n = _atc._date || new Date(), m = n.getDate(), p = (n.getMonth() + 1);
                if (p < 10) {
                    p = "0" + p;
                }
                if (m < 10) {
            ...
            function b(q, o, p, n, s) {
                ...
                function r(y) {
                    if (_a.uls) {
                        var z = JSON.parse(l.get(y) || "{}"), v = parseInt(z.m) || c, x = parseInt(z.k) || e, w = z.l, u = z.b;
        ...
        (function(f, t, w) {
            var x = f, j = new Date().getTime(), s = function() {
                ...
                var z = (A || "").split("?"), a = z.shift(), B = (z.pop() || "").split("&");
                return C(a, B);
            }, k = function(a, z, B, A) {
                if (!z) {
                    z = {};
                ...
                return h(a, function(A, D) {
                    var z = A.indexOf(";jsessionid"), E = [], B, C;
                    if (z > -1) {
                        A = A.substr(0, z);
                    }
                    if (D) {
                ...
                B = B.split("/");
                var z = B.shift(), E = B.shift(), A = B.shift(), C = B.shift(), D = B.shift(), a = B.shift();
                if (A) {
                    x.ab = x.ab;
                }
                if (C) {
                ...
                var a = A.url, B = A.params, z = A.js, E = A.rand, H = A.close, G = a + (B ? "?" + (E ? (_a.track.ran() + (E == 2 ? ("&colc=" + (new Date()).getTime()) : "")) : "") + "&" + B : "");
                if (z) {
                    _a.ajs(G, 1);
                } else {
                    if (H) {
                        var F = document, C = F.createElement("iframe");
                        C.id = "_atf";
                        C.src = G;
                        _a.opp(C.style);
            ...
            f.util.extend(_a.track, {fcv: o,ran: s,rup: v,aup: m,cof: e,gof: q,clu: l,mgu: k,ssid: i,sta: b,uns: r,lpx: u,sxm: c});
        })(_a, _a.api, _a);
        (function(e, o, p) {
            ...
            function r(S, Q) {
                ...
                var R, Z, H, X, K, C = 0, D = 0, M = S ? S.href : "", J = (M || "").split("#").shift(), x = S.hash.substr(1), L = _a.util.ghp(S.search, 1), O = _a.util.ghp(S.hash), G = O.at_st, V = O.at_pco, P = O.at_ab, U = O.at_pos, d = O.at_tot, N = O.at_si, y = L.sms_ss, F = L.fb_ref, u = L.at_xt, Y, z = L.at_st, aa, W, E, I, A, v, T;
                if (!G) {
                    if (n(x)) {
                ...
                var B = {ab: P || null,pos: U,tot: d,rsi: Z,cfc: H,hash: C,rsiq: X,fuid: K,rxi: R,rsc: y,gen: D,csi: N};
                return B;
            }
            function i(d) {
        ...
        (function(c, d, e) {
            var h, a = "hist", i = 0, f = new c.data.bloom.library(a, 3), j = c.data.storage;
            function b(k) {
        ...
        (function(g, h, l) {
            var q = {}, j = {}, b = 0, d = new g.cookie.KV("rfs", 1), f = null;
            function i(r) {
                if (r == "t.co") {
                    return "twitter";
                }
            ...
            function n(u, t) {
                var v = o(u), x = u ? g.dr : (v.dr || g.dr), r = (document.location || {}).href || "", s = g.ad.clr(x), y = {}, z, w, A;
                if (b) {
        ...
        (function() {
            var d = document, a = _a, _37d = 0, cvt = [], avt = null, pix = "tev", evu = "//o.addthis.com/at/", ssc = function(rsc) {
            ...
            }, _385 = {ftho: 1,aqe3: 1,d99r: 1,neud: 1,"8elu": 1,bqfn: 1}, _386 = Math.random() < _atc.csmp, _387 = true, _388 = new RegExp(/\(?(\d{3})\)?[\- ]?(\d{3})[\- ]?(\d{4})/g), _389 = new RegExp(/^((([a-z]|[0-9]|\-)+)\.)+([a-z])+$/ig), qtp = [], xtp = function() {
                var p;
                while (p = qtp.pop()) {
                    trk(p);
                }
            }, atf = null, vpcs = [], lvpc = null, vpex = [], pcs = [], spc = null, _393 = 0;
            function avpc(c) {
                c = c.split("-").shift();
            ...
            function onMenuFollow(e) {
                if (e && e.data && e.data.service && e.data.url) {
                    trk({gen: a.ad.type.FOLLOW,pix: "dest=" + e.data.service,svc: e.data.service,url: e.data.url});
                }
            }
            function onMenuShare(e) {
                ...
                if (e && e.data && e.data.service) {
                    ...
                    trk({gen: (e.data.service.indexOf("facebook") > -1 || e.data.service == "more" || e.data.service == "settings" || e.data.service == "link" || (_atc.ver >= 300 && e.data.service == "email")) ? a.ad.type.NOOP : a.ad.type.SHARE,pix: "dest=" + e.data.service,svc: e.data.service,url: (e.data.url || null)});
            ...
            function onMenuPop(evt) {
                var t = {}, data = evt.data || {}, svc = data.svc, pco = data.pco, _3b8 = data.cmo, _3b9 = data.crs, _3ba = data.cso;
                if (svc) {
                    t.sh = svc;
                }
                if (_3b8) {
            ...
            function dirxmi(_3d2) {
                ...
                if (cvt.length > 0) {
                    ...
                    cvt = [];
                    a.track.lpx({url: url,close: _3d2});
                }
            }
            ...
            function trackConversion(_3da) {
                var t = {}, ts = a.track.ts.get(false), ref, ex = "", _3df = {sku: 1,brand: 1,model: 1,id: 1,value: 1,label: 1,category: 1};
            ...
            function trackSocial(typ, _3e3) {
                var id = (_3e3 || {}).id || _a.uid, _3e5 = (_3e3 || {}).service || "unk";
                cev("typ", typ);
                ...
                if (window.getSelection) {
                    ...
                    if (text.length) {
                        ...
                        if (_3ea.length && _3ea.length <= 5 && (!a.dcp || a.dcp < a.ad.type.COPY)) {
                            setTimeout(function() {
                                trk({gen: a.ad.type.COPY,pix: "tt=" + _euc(_3ea.join(" "))});
            ...
            a.util.extend(a.track, {pcs: pcs,apc: apc,avpc: avpc,avp: addVisibleProduct,cev: cev,ctf: ctf,jsl: jsl,prod: prod,osc: onSocialConnect,gtf: get_atssh,qtp: function(p) {
                    qtp.push(p);
                },ssc: ssc,stf: function(f) {
                    atf = f;
                },trk: trk,trl: onLinkClick,xtp: xtp,msg: msg,trc: trackConversion});
        })();
        _41(_a, {_rec: [],xfr: !_a.upm || !_a.bro.ffx,pmh: function(e) {
                var data, r = _a._rec;
        ...
        _41(_a, {_tc: function(_3f2, _3f3, id, lng) {
                var o = window.addthis_translations;
                if (!o) {
                    _a._t._q = _a._t._q || [];
                    _a._t._q.push({eng: _3f3,id: id,lng: lng});
                    if (!_a._t._qw) {
                        var _3f7 = function() {
                            var _3f8 = _a._t._q;
        ...
        _41(_a, {trim: function(s, e) {
                ...
                return s || "";
            },trl: [],tru: function(u, k, _415) {
                var rv = "", _417 = 0, _418 = -1;
                if (_415 === _1) {
                    _415 = 300;
                }
                if (u) {
                ...
                st.zIndex = 100000;
            },jlr: {},ajs: function(name, _41c, _41d, id, el, _420) {
                if (!_a.jlr[name] || _420) {
                    var o = d.ce("script"), ssl = (window.location.protocol == "https:"), _423 = "", head = (el) ? el : d.gn("head")[0] || d.documentElement;
        ...
        (function(g, u, v) {
            var e = g.util.each, y = g.util.map, d;
            function h(C, B, A, F) {
                var E = "Cwm fjordbank glyphs vext quiz", D = C.getContext("2d");
                D.font = B;
            ...
            function o() {
                ...
                return {isInstalled: D,version: A,name: C};
            }
            function k() {
                var D = false, A = "", F = null, B = "", C = "";
                try {
            ...
            function n() {
                var E = false, A = "", F = ["rmocx.RealPlayer G2 Control", "rmocx.RealPlayer G2 Control.1", "RealPlayer.RealPlayer(tm) ActiveX Control (32-bit)", "RealVideo.RealVideo(tm) ActiveX Control (32-bit)", "RealPlayer"], H = null, B = "", C = "";
                ...
                return {isInstalled: E,version: A,name: C};
            }
            function b() {
                var D = false, A = "", F = null, B = "", C = "";
                try {
                ...
                try {
                    if (window.navigator.plugins && window.navigator.plugins.length) {
                        for (var G = 0, E = window.navigator.plugins.length; G < E; G++) {
                            var B = window.navigator.plugins[G]["name"] || "", I = window.navigator.plugins[G]["version"] || "", A = window.navigator.plugins[G]["filename"] || "", J = window.navigator.plugins[G]["description"] || "";
                            if (!F[B]) {
                                F[B] = 1;
                                D.push(B + ";" + (I || A) + ";" + J);
                            }
            ...
            function w() {
                var C = m(), B = C.substr(0, Math.floor(C.length / 2)), A = C.substr(Math.floor(C.length / 2));
                return (g.math.murmur32(B, 31)) + "" + (g.math.murmur32(A, 31));
            }
            if (!g.ad) {
                g.ad = {};
            }
            _a.extend(g.ad, {gpl: t,gce: f,gfp: c,glfp: w});
        })(_a, _a.api, _a);
        (function(e, g, f) {
            var c = e.mun, d = e.ad.gpl(), b = e.ad.gce();
            function h() {
                var n = c(navigator.userAgent, 16), j = ((new Date()).getTimezoneOffset()) + "" + navigator.javaEnabled() + (navigator.userLanguage || navigator.language), l = w.screen.colorDepth + "" + w.screen.width + w.screen.height + w.screen.availWidth + w.screen.availHeight, k = navigator.plugins, o;
                try {
                    o = k.length;
                    if (o > 0) {
        ...
        (function(b, B, l) {
            ...
            function h() {
                y();
                var P = (D.addthis_title || L.title), i = e(P), w = (E || "").length, d, R, Q, O;
            ...
            function M() {
                var d = (new Date()).getTime(), i, j = [];
                _a.util.each(t, function(O, w) {
                    j.push({name: "1|" + O,weight: Math.round(w * 100) / 100});
                });
                j.sort(function(O, w) {
            ...
            _a.extend(b.ad, {cla: h,gog: I,og: z,kw: J,gcv: M,gch: g});
        })(_a, _a.api, _a);
        (function(c, f, i) {
            var g = 0, b = 1, a = 2, h = 4;
            function d(m, l, k) {
        ...
        (function(g, i, j) {
            var e, n = window, h = n.addthis_config || {}, k = document, p = g.util, c = g.event.EventDispatcher, m = 25, f = [];
            function o(s) {
                var d, r;
                if (s && s instanceof a) {
                    f.push(s);
            ...
            function b() {
                ...
                this.checkload = function() {
                    this.waiting--;
                    if (this.waiting == 0) {
                        r.fire("load", this.resources, {resources: this.resources});
                    }
                };
                this.add = function(s) {
                    if (s) {
            ...
            function a(u, r, t) {
                ...
                a.addEventListener("load", function(v) {
                    ...
                    if (d.loading) {
                        d.loading = false;
                        d.ready = true;
                        s.fire(v.type, w, {resource: w});
                    }
                });
            }
            p.extend(a.prototype, {load: function() {
                    if (!this.loading) {
            ...
            p.extend(a, {known: {},loading: f,monitor: o});
            function l(s) {
            ...
            g.resource = {Resource: a,convert: l,Bundle: b};
        })(_a, _a.api, _a);
        (function(b, f, d) {
        ...
        (function(b, z, g) {
            ...
            function E(T, U, S, Q) {
                if (T == "more" && _a.ver() >= 300 && !_a.bro.wph && !_a.bro.iph && !_a.bro.dro) {
                    ...
                    if (_a.bro.msi && P.length > 2000) {
                        P = P.split("&atc")[0];
                        var a = {product: Q.product,data_track_clickback: Q.data_track_clickback,pubid: Q.pubid,username: Q.username,pub: Q.pub,ui_email_to: Q.ui_email_to,ui_email_from: Q.ui_email_from,ui_email_note: Q.ui_email_note};
                        if (_atw.ics(T)) {
            ...
            function j(Q, P) {
                var a = {pinterest_share: "pinterest",pinterest_pinit: "pinterest"}, R = null;
                if (a[P]) {
                    if (((Q || {}).passthrough || {})[P]) {
                        R = Q.passthrough[P];
                    } else {
            ...
            function f(ah, V, ak, ap) {
                var ab = O.trim, am = w, aj, R, U, al, af, ai = O.pub(), ae = w._atw || {}, aa = (ak && ak.url ? ak.url : (ae.share && ae.share.url ? ae.share.url : (am.addthis_url || am.location.href))), ao, T = function(at) {
                    if (aa && aa != "") {
                        al = aa.indexOf("#at" + at);
                        if (al > -1) {
                            aa = aa.substr(0, al);
                ...
                var an = ((ak.templates && ak.templates[ah]) ? ak.templates[ah] : ""), ad = ak.smd || O.smd, P = ((ak.modules && ak.modules[ah]) ? ak.modules[ah] : ""), S = ak.share_url_transforms || ak.url_transforms || {}, Y = ak.track_url_transforms || ak.url_transforms, ar = ((S && S.shorten) && ah.indexOf("pinterest") === -1 ? (typeof (S.shorten) == "string" ? S.shorten : (S.shorten[ah] || S.shorten["default"] || "")) : ""), W = "", ag = (ap.product || am.addthis_product || ("men-" + _a.ver())), Q = w.crs, X = "", ac = O.track.gof(aa), aq = ac.length == 2 ? ac.shift().split("=").pop() : "", a = ac.length == 2 ? ac.pop() : "", Z = (ap.data_track_clickback || ap.data_track_linkback || !ai || ai == "AddThis") || (ap.data_track_clickback !== false && _a.ver() >= 250);
            ...
            function p(W, Y, S, X, P, Z) {
                var V = O.pub(), a = X || Y.url || "", R = Y.xid || O.util.cuid(), Q, U, T = (S.data_track_clickback || S.data_track_linkback || !V || V == "AddThis") || (S.data_track_clickback !== false && _a.ver() >= 250);
            ...
            function o(S, Q, a) {
                var Q = Q || {}, R = S.share_url_transforms || S.url_transforms || {}, P = O.track.cof(O.track.mgu(S.url, R, S, "mailto")), T = S.title ? S.title : P;
            ...
            function F(P, R, Z, Q, W) {
                var V = R || 550, S = Z || 450, Y = screen.width, T = screen.height, U = Math.round((Y / 2) - (V / 2)), a = 0;
                if (T > S) {
            ...
            function r(V, U, W, S, R, X, Q, a) {
                var T = {wordpress: {width: 720,height: 570},linkedin: {width: 600,height: 400},twitter: {width: 520,height: 520},"default": {width: 550,height: 450}}, P = x(V, U, a);
                q(V, 1, W, S);
            ...
            function H(V, U, R, T, a, Q) {
                var S = {wordpress: {width: 720,height: 570},linkedin: {width: 600,height: 400},facebook: {width: 675,height: 375},email: _a.ver() >= 300 ? {width: 660,height: 660} : {width: 735,height: 450},more: _a.ver() >= 300 ? {width: 660,height: 716} : {width: 735,height: 450},vk: {width: 720,height: 290},raiseyourvoice: {width: 480,height: 635},"default": {width: 550,height: 450}}, P = E(V, 0, U, R);
            ...
            function n(T, R, U, P) {
                var S = T.share_url_transforms || T.url_transforms || {}, a, Q = O.track.cof(O.track.mgu(T.url, S, T, "twitter"));
                if (!T.templates) {
                    T.templates = {};
                }
                Q = E("twitter", 0, T, R);
            ...
            function m(S, R, a, P, U) {
                var Q = (U ? "follow" : (S.indexOf("_comment") > -1 ? "comment" : "share")), T = {element: P || {},service: S || "unknown",url: U ? R.followUrl : (R.trackurl || R.url)};
            ...
            b.share = b.share || {};
            b.util.extend(b.share, {auw: k,ocw: F,onw: i,caw: A,ftw: r,stw: H,siw: L,pts: n,unt: t,uadd: f,genurl: E,geneurl: I,genieu: o,acb: p,gcp: J,gfu: x,svcurl: G,track: q,notify: m,links: C,register: h,registerListeners: y,sub: M,registerSubscriber: B,extern: v,externEvents: u});
        })(_a, _a.api, _a);
        (function(f, y, B) {
            var E = document, i = {}, h = {}, q, D = [], e = 0, v = 0, x = 0, m = true, G = 1, z = 0, j = E.domain.search(/\.addthis\.com$/i) != -1 ? 1 : 0, o = _a.bro.mob ? "http://m.facebook.com/sharer.php" : "http://www.facebook.com/sharer/sharer.php";
            function s() {
            ...
            function A(J, H) {
                var d = {}, K = h[H], I = (addthis_config.data_ga_tracker || addthis_config.data_ga_property);
            ...
            function u(d, L) {
                var K = "fb-root", I = E.getElementById(K), H = w.fbAsyncInit, N = false, J = function() {
                    N = true;
                ...
                if (t() && FB.XFBML && FB.XFBML.parse) {
                    ...
                    if (!H) {
                        ...
                        if (!H) {
                            ...
                            M.src = E.location.protocol + "//connect.facebook.net/" + (L || _a.gfl(_a.lng())) + "/all.js";
                            M.async = true;
                            I.appendChild(M);
                            H = function() {
                                var Q = E.getElementsByTagName("meta"), O = null;
                                for (var P = 0; P < Q.length; P++) {
                                ...
                                FB.init({appId: O ? O : (j ? "140586622674265" : "172525162793917"),status: true,cookie: true});
                            };
                        }
                    }
                    if (m) {
            ...
            function r(N, L) {
                ...
                var K = M.layout || "button_count", d = {standard: [450, M.show_faces ? 80 : 35],button_count: [90, 25],box_count: [55, 65]}, O = M.width || (d[K] ? d[K][0] : 100), I = M.height || (d[K] ? d[K][1] : 25);
                ...
                if (s()) {
                    ...
                    if (M.href === _1) {
                        M.href = _a.track.mgu(L.share.url, {defrag: 1});
                    }
                    if (!L.share.xid) {
                    ...
                    J.style.width = O + "px";
                    J.style.height = I + "px";
                    J.src = "//www.facebook.com/plugins/subscribe.php?href=" + _euc(_a.track.mgu(L.share.url, {defrag: 1})) + "&layout=button_count&show_faces=false&width=100&action=subscribe&font=arial&" + passthrough;
                    if (!_a.bro.msi) {
                        N.appendChild(J);
                    }
                }
            ...
            function F(N, L) {
                ...
                var O, I, d, M = _a.api.ptpa(N, "fb:like"), K = M.layout || "button_count", H = {standard: [450, M.show_faces ? 80 : 35],button_count: [90, 25],box_count: [55, 65]}, P = M.width || (H[K] ? H[K][0] : 100), J = M.height || (H[K] ? H[K][1] : 25);
                passthrough = _a.util.toKV(M);
                _a.ufbl = 1;
                if (s()) {
                    if (M.layout === _1) {
                    ...
                    O.style.width = P + "px";
                    O.style.height = J + "px";
                    O.src = "//www.facebook.com/plugins/like.php?href=" + _euc(_a.track.mgu(L.share.url, {defrag: 1})) + "&layout=button_count&show_faces=false&width=100&action=like&font=arial&" + passthrough;
                    if (!_a.bro.msi) {
                        N.appendChild(O);
                    }
                }
            ...
            f.share = f.share || {};
            f.share.register({facebook_like: F,facebook_send: C,facebook_share: a,facebook_subscribe: r});
            f.share.registerSubscriber(g);
            f.share.registerListeners({facebook: {_after: function(d) {
                        d.ins = 1;
                        d.noh = 1;
                    },onclick: function(H) {
                        var I = H.el, d = H.service;
            ...
            f.share.fb = {like: F,send: C,subs: r,has: t,ns: p,ready: s,compat: n,share: b,sub: g,load: u};
        })(_a, _a.api, _a);
        (function(e, f, i) {
        ...
        (function(b, e, c) {
            ...
            function a(g, d, h) {
                ...
                var j = _parseThirdPartyAttributes(g, "pi:pinit"), l = _a.util.clone(d.share), k;
                ...
                if (j.media || j.layout) {
                    j.url = l.url = j.url || k.url || _a.track.mgu(l.url, {defrag: 1});
        ...
        (function(f, g, h, e) {
            ...
            function a(n, l, q) {
                ...
                var m = _a.util.clone(l.share), k = {type: "webpage",url: l.share.url,title: l.share.title,style: "number"}, r = _parseThirdPartyAttributes(n, "wb:like"), p = j(), o = c(r, p), d = c(k, p);
            ...
            function j() {
                var o = i.getElementsByTagName("meta"), d = {}, p, k, n, m;
        ...
        (function(h, i, k) {
            ...
            function g(p, o, q) {
                ...
                var d = _parseThirdPartyAttributes(p, "su:badge"), t = d.style || "1", u = o.share.url = d.href || _a.track.mgu(o.share.url, {defrag: 1}), s = d.height || "20px", r = d.width || "75px";
                if (t == "5") {
                    s = d.height || "60px";
                } else {
                    if (t == "6") {
            ...
            function c(A, y) {
                ...
                var o = l.ce("div"), p = "http://userapi.com/js/api/openapi.js?52", s = y.share.url.replace(/#.*$/, ""), v = y.share.title, d = y.share.description, r = _parseThirdPartyAttributes(A, "vk"), t = r && (r.apiId || r.apiid), q = {type: "full",pageDescription: d,pageTitle: v,pageUrl: s}, z = function() {
                    return w.VK && w.VK.init && w.VK.Widgets && w.VK.Widgets.Like;
                }, u = function(B) {
                    VK.init({apiId: t,onlyWidgets: true});
            ...
            function j(o, d) {
                ...
                var p = _parseThirdPartyAttributes(o, "4sq"), q = document.createElement("a");
                q.href = "https://foursquare.com/intent/venue.html";
            ...
            function f(o, d) {
                ...
                var r = _parseThirdPartyAttributes(o, "rk:healthy"), q = l.createElement("div"), p = new _a.resource.Resource("runkeeperjs", "//runkeeper.com/static/js/healthy/rkHealthyButton.js");
            ...
            function m(o, d) {
                ...
                var r = _parseThirdPartyAttributes(o, "svejo:"), q = document.ce("div"), p = new _a.resource.Resource("svejojs", "//svejo.net/button.js", function() {
                ...
                r.href = d.share.url = r.href || _a.track.mgu(d.share.url, {defrag: 1});
            ...
            function b(r, p) {
                ...
                var d = _parseThirdPartyAttributes(r, "li"), u = p.share, s = d.width || 100, o = d.height || 18, q, v = "", t;
                if (!d.counter) {
            ...
            function n(s, q) {
                var r = _parseThirdPartyAttributes(s, "am:wishlist"), v = q.share.url = r.url = r.url || _a.track.mgu(q.share.url, {defrag: 1}), p = l.ce("div"), t = l.ce("div"), d = l.ce("div"), u = l.ce("div"), o = addthis_config || {};
                o.hdl = 1;
                if (!r.id) {
                ...
                s.appendChild(u);
                _a.ajs("http://www.amazon.com/wishlist/bookmarklet/getbutton.js?name=" + r.id + "&image=" + (r.style || "2"), 1, "1", "AddToAUWLButton." + r.id, s);
                s.onclick = function() {
            ...
            function a(o, d) {
                ...
                var s = _parseThirdPartyAttributes(o, "tm"), r = 50, q = 61;
                ...
                var p = o.firstChild;
                p.src = "//api.tweetmeme.com/button.js?url=" + _euc(d.share.url) + "&" + passthrough;
                o.noh = o.ost = 1;
            }
            h.share = h.share || {};
            h.share.register({foursquare: j,svejo_counter: m,linkedin_counter: b,runkeeper_healthy: f,stumbleupon_badge: g,tweetmeme: a,vk_like: c});
            h.share.registerListeners({more: {require: function(o, p, d) {
                        return !p.noh && _a.ver() >= 300 && !_a.bro.iph && !_a.bro.wph && !_a.bro.dro;
                    },onclick: function(d) {
                        var p = d.el || {};
                        window.addthis.menu(p, p.conf, p.share);
                        return false;
                    }},email: {require: function(o, p, d) {
                        return !p.noh && _a.ver() >= 300 && !_a.bro.iph && !_a.bro.wph && !_a.bro.dro;
                    },onclick: function(q) {
        ...
        (function(f, g, k) {
            ...
            function b(t, Y, Z) {
                ...
                if (V && !Y) {
                    ...
                    for (var T in u) {
                        ...
                        p.push({src: unescape(W[0]),offsetHeight: W[1],offsetWidth: W[2],alt: W[3],og: W[4]});
                    }
                    if (!o && !Y && _a.ver() < 300) {
                    ...
                    for (var T in p) {
                        ...
                        var I = d.createElement("img"), L = d.createElement("span"), q = d.createElement("span"), A = d.createElement("span"), X = d.createElement("div"), N = 4;
                        I.alt = I.title = E.alt;
                        if (_a.ver() >= 300) {
                        ...
                        I.onclick = X.onclick = function() {
                            ...
                            x.passthrough.pinterest_share = {media: this.parentNode.getElementsByTagName("img")[0].src,description: (this.title || this.alt || x.description || x.title || this.parentNode.getElementsByTagName("img")[0].src.split("/").pop() || "")};
                            if (Y) {
                                x.url = _euc(x.url);
                                if (_a.ver() >= 300) {
                                    _a.share.track((U ? "pinterest_share" : t), 0, x, addthis_config, this);
                                    h({windowUrl: H.img_base_url + "?" + H.img_param + _euc(x.passthrough.pinterest_share.media) + "&url=" + x.url + "&description=" + _euc(x.passthrough.pinterest_share.description) + H.ctype,width: H.windowProps.width,height: H.windowProps.height}, H.img_service);
                                } else {
                    ...
                    if (J == 1 && !a()) {
                        ...
                        S.passthrough.pinterest_share = {media: v.src,description: (S.title || v.src.split("/").pop() || "")};
                        if (_a.ver() >= 300 && _a.share.inBm()) {
                            _a.share.notify((U ? "pinterest_share" : t), S, addthis_config_msg, this);
                            h({windowUrl: H.img_base_url + "?" + H.img_param + _euc(S.passthrough.pinterest_share.media) + "&url=" + S.url + "&description=" + _euc(S.passthrough.pinterest_share.description) + H.ctype,width: H.windowProps.width,height: H.windowProps.height}, H.img_service);
                            return false;
                        } else {
                            h({windowUrl: H.img_base_url + "?" + H.img_param + _euc(S.passthrough.pinterest_share.media) + "&url=" + S.url + "&description=" + _euc(S.passthrough.pinterest_share.description) + H.ctype,width: H.windowProps.width,height: H.windowProps.height}, H.img_service);
                            ((d.getElementById("atImgBox_" + t) || {}).style || {}).display = "none";
            ...
            function n(y, J, x, B) {
                var C = "", r = new Array(), G = new Array(), H, u = new Array(), s = (((w.addthis_share_msg || w.addthis_share || {}).passthrough || {}).pinterest_share || {}), A = s.media, F = s.description, t = s.pi_media, I = s.pi_media_desc, D = false, z = null, p = typeof x == "string" ? x : (typeof (w.addthis_config || {}).image_include == "string" ? addthis_config.image_include : null), o = typeof B == "string" ? B : (typeof (w.addthis_config || {}).image_exclude == "string" ? addthis_config.image_exclude : null);
                ...
                if (A) {
                    r[A] = true;
                    G.push({url: A,title: F});
                }
                if (t) {
                    r[t] = true;
                    G.push({url: t,title: I});
                }
                for (var E in z) {
            ...
            function h(q, s) {
                var u = {height: 350,left: 0,location: 0,menubar: 0,resizable: 0,scrollbars: 0,status: 0,width: 700,windowName: null,windowURL: null,top: 0,toolbar: 0};
                _a.util.mrg(q, u);
                var p = "height=" + q.height + ",width=" + q.width + ",toolbar=" + q.toolbar + ",scrollbars=" + q.scrollbars + ",status=" + q.status + ",resizable=" + q.resizable + ",location=" + q.location + ",menuBar=" + q.menubar, r = (screen.height - q.height) / 3, t = (screen.width - q.width) / 2, o = window.open(q.windowUrl, q.windowName, p + ",left=" + t + ",top=" + r);
                if (o) {
                    o.focus();
                }
                _a.xf.send(window.parent, "addthis.menu.shareimg", {service: s,type: "share"});
            }
            f.share = f.share || {};
        ...
        (function(b, c, e) {
            ...
            b.services.refget = function(f) {
                ...
                var g = {"mail.google.com": "gmail","mail.yahoo.com": "yahoomail","mail.aol.com": "aolmail","mail.live.com": "hotmail"};
                if (g[f]) {
                    return g[f];
                }
        ...
        (function(g, s, u) {
            var v, d, c, k = {}, h, n, r, b, e = _a.util.each;
            function f(B) {
                var D = new Array();
            ...
            function l(F) {
                a();
                var B = j(), E = function() {
                    var K = g.cookie.ssc.getServices(), I = g.ups || {}, J;
            ...
            function z(aa, X) {
                if (aa === c) {
                    return {conf: aa,csl: r,crs: b};
                }
                c = aa;
                var Q = window.addthis_ssh ? addthis_ssh.replace("misterwong_de", "misterwong").replace("misterwong_ru", "misterwong").replace(/(^more,)|(^more$)|(,more,)|(,more$)/, "").split(",") : [], E = "facebook,twitter,email,print,gmail,stumbleupon,favorites,gmail,tumblr,pinterest_share,google,mailto,linkedin,blogger,delicious,yahoomail,hotmail,printfriendly,aolmail,livejournal,wordpress,friendfeed", V = E, O = (window.addthis_services_loc || E).replace(((_a.bro.xp || _a.bro.mob) ? (/,mailto,/) : (/,,/)), ","), R = 0, P = O, N = j();
                y(aa);
                if (_a.bro.ipa) {
                ...
                if (((window.addthis_ssh && window.addthis_use_personalization && R) || X.length || aa.services_exclude || addthis_exclude)) {
                    var D = addthis_options_rank.split(","), L = [], U, B = (aa.services_exclude || addthis_exclude || "").split(","), H = {}, T, Z = Q.join(","), ac = [], A = {}, x = 0, K = 11, J = 0, F = aa.product || "", G = F.indexOf("ffext") > -1 || F.indexOf("fxe") > -1;
                    ...
                    if (Y % 2 === 0 || Y < 11) {
                        var W = Math.min(Y, 11), M = P.split(","), I = Y;
        ...
        (function(e, A, k) {
            ...
            function C(Y, ac, w) {
                var Z = Y.pubid || e.pub(), d = window.addthis_domain ? _a.util.gUD(window.addthis_domain) : "", ab = d || Y.domain, aa;
            ...
            function V() {
                return true;
                try {
                    var Z = _a.mun(document.location.hostname.split(".").slice(-2).join(".")), w = Z.charAt(0), d = {ke4m: 1,"1stj": 1,u880: 1,nl2f: 1,cvt2: 1,e86k: 1,"6aio": 1,o598: 1,po2f: 1,a462: 1,n22r: 1,kj68: 1};
                    if (d[Z]) {
                        return true;
                    }
                } catch (Y) {
            ...
            function j(d) {
                ...
                if (!z.vectors || w === 0) {
                    ...
                    var Z = z.vectors[0], Y = z.vectors[1];
                    if (w == 1) {
                        if (e.bt2 || (Z != t && Z != X)) {
                            E(d, z.feed, Z);
                        } else {
            ...
            function r(Z) {
                ...
                f();
                var Y = Z.pubid || e.pub(), w = h, d, ae = Math.floor(Z.total / 2), aa = "__feed_" + Y + "_" + h, af = false, ab = 0;
                if (!N && (V() || w == 14)) {
                    N = {features: e.ad.gcv()};
                }
            ...
            function b(af, ac, w) {
                var Y, aa = new K(), Z = 0, ab = [], d, ad, w = typeof w == "function" ? w : y, ae;
            ...
            function T(Y, d, aa, w) {
                ...
                var ab = b(d, aa, y), ad = ab, Z = Y.split;
                if (Z) {
                    ad = [];
                    var ac = w ? ab : d;
                    second = w ? d : ab;
            ...
            function o(Z) {
                var Y = Z.url, d = Z.pco, ac = Z.total, ae = Z.pos, w = Z.bt, ad = Z.ab || "-", aa = "cfd-1.0";
            ...
            e.feeds = {ab: f,_ad: V,configure: M,get: C,recommend: r,trend: I,decorator: g};
            e.dctu = o;
        })(_a, _a.api, _a);
        ...
        function main() {
            ...
            try {
                ...
                var a = _a, msi = a.bro.msi, hp = 0, _858 = w.addthis_config || {}, dt = d.title, dr = (typeof (a.rdr) !== "undefined") ? a.rdr : (d.referer || d.referrer || ""), du = dl ? dl.href : null, dh = dl.hostname, _85d = du, _85e = 0, al = (_a.lng().split("-")).shift(), _860 = _a.track.eop(dl, dr), cvt = [], nabc = !!a.cookie.rck("nabc"), cfc = _860.cfc, ab = _860.ab, pos = _860.pos ? parseInt(_860.pos, 10) : null, tot = _860.tot ? parseInt(_860.tot, 10) : null, rsiq = _860.rsiq, rsi = _860.rsi, rxi = _860.rxi, rsc = _860.rsc.split("&").shift().split("%").shift().replace(/[^a-z0-9_]/g, ""), gen = _860.gen, fuid = _860.fuid, csi = _860.csi, _86e, ifr, _870 = _atc.rsrcs.sh + "#", data, _872 = function() {
                    if (!_a.track.pcs.length) {
                        _a.track.apc(w.addthis_product || ("men-" + _a.ver()));
                    }
                    data.pc = _a.track.pcs.join(",");
                }, ljep = w.ljep || false, _874 = a.pub(), _875 = [2, 3, 4, 12];
                ...
                try {
                    ...
                    if (!(atsp.pinterest_share || {}).media) {
                        var tags = _a.ad.og(), _87a = {}, og = typeof (tags) == "string" ? _a.util.fromKV(tags) : tags;
                        atsp = {};
                ...
                if (!w.addthis_config.ignore_server_config && _874) {
                    if (_a.upm && !a.bro.ie6 && !a.bro.ie7) {
                        _a.ipc = true;
                        var _87e = "__atpro_" + _874, _87f = "", _880 = false, _881 = false, _882 = _a.uls, _883 = {cfs: true}, _884 = function _884(_885) {
                            _a.isProUser = true;
                        ...
                        var _889 = "__atpro_" + _874, _88a = _a.cookie.rck(_889), _88b = new Date(), _88c = {pubid: _874}, cb = function(_88e) {
                ...
                if (a.vamp >= 0 && !a.sub) {
                    if (cfc) {
                        ...
                        cvt.push(a.track.fcv("pur", a.track.mgu(_85d, {defrag: 1})));
                        if (a.dr) {
                ...
                if (_85e) {
                    ...
                    _a.ed.fire("addthis.user.clickback", w.addthis || {}, {service: _85e,hash: _a.hash});
                }
                ...
                if (!nabc && w.history && typeof (history.replaceState) == "function" && (!_a.bro.chr || _a.bro.chb) && (_858.data_track_addressbar || _858.data_track_addressbar_paths) && ((du || "").split("#").shift() != dr) && (du.indexOf("#") == -1 || rsi || (_860.hash && rxi) || cfc)) {
                    var path = dl.pathname || "", _890, _891 = path != "/";
                    ...
                    if (_891 && (!rsi || a.util.ioc(rsi, 5))) {
                        ...
                        history.replaceState({d: (new Date()),g: gen}, d.title, _86e);
        ...
        a._rec.push(function(data) {
            ...
            if (data.per) {
                if (!a.ipc && a.sfmp > 0) {
                    var per = {"per-feed": data["per-feed"],"per-cell": data["per-cell"],"per-vectors": (data["per-vectors"] || "NONE").split(",")};
        ...
        try {
            ...
            var _8a2 = {}, _245 = _a.util.gsp("addthis_widget.js");
            if (typeof (_245) == "object") {
                if (_245.provider) {
                    _8a2 = {provider: _a.mun(_245.provider_code || _245.provider),auth: _245.auth || _245.provider_auth || ""};
            ...
            if (_atc.ver === 120) {
                var rc = "atb" + _a.util.cuid(), _8a4 = _a.util.gst("addthis_widget"), span = d.ce("span");
                span.id = rc;
        ...
        (function(e, g, i) {
            ...
            _41(_a, {xf: {upm: m,listen: function() {
                        if (h) {
                            return;
                        }
                        if (m) {
        ...
        (function() {
            var _8e8 = 0, _8e9 = [{name: "menujs",url: _atc.rsrcs.menujs,test: function() {
                        return !!window._atw;
                    }}], _8ea = {".addthis-recommendedbox": "recommendedbox"};
            if (!_8e8) {
                window.addthis.auth = {};
                window.addthis.bar = {};
                ...
                _a.api.register({context: window.addthis.login,methods: {initialize: {callback: function() {
                            ...
                            }}},resources: [{name: "sso",url: _atc.rsrcs.ssojs,test: function() {
                                return _6.login.ost;
                            }}, {name: "ssocss",url: _atc.rsrcs.ssocss}]});
                _a.api.addAsync({resources: [{name: "lightboxcss"}, {name: "lightbox",test: function() {
                                return _6.lightbox.ost;
                            }}],method: "lightbox",context: window.addthis,callback: function(_8eb) {
                        _6.lightbox(_8eb);
                    }});
                _a.api.addAsync({resources: _8e9,method: "menu",event: "addthis.menu.ready",callback: function() {
                        _a.menu.open.apply(_a.menu, arguments);
                    }});
                _a.api.addAsync({context: window.addthis.menu,method: "close",resources: _8e9,event: "addthis.menu.ready",callback: function() {
                        _a.menu.close.apply(_a.menu.close, arguments);
                    }});
                _a.api.register({context: window.addthis.bar,methods: {initialize: {resources: [{name: "layersjs",url: _atc.rsrcs.layersjs}],oncall: function() {
                ...
                _a.api.addAsync({resources: [{name: "auth",url: _atc.rsrcs.authjs}],method: "init",context: window.addthis.auth,event: "addthis.auth.ready",callback: function() {
                    }});
                _a.api.addAsync({resources: [{name: "contentjs",url: _atc.rsrcs.contentjs,test: function() {
                                return _6.box.ost;
                            }}, {name: "contentcss",url: _atc.rsrcs.contentcss}],method: "box",pre: function(what) {
                ...
                _a.api.addAsync({resources: [{name: "overlayjs",url: _atc.rsrcs.overlayjs,test: function() {
                                return (_6.overlay || {}).ost;
                            }}],method: "overlay",pre: function() {
                        _a.track.apc("ovr-" + _a.ver());
                    }});
                _a.api.register({resources: [{name: "layersjs",url: _atc.rsrcs.layersjs}],methods: {layers: {event: "addthis.layers.ready",callback: function() {
                                _6.layers.apply(_6.layers, arguments);
                            },oncall: function() {
                                var i = -1, x, obj, args, _8f4 = true, _8f5 = {share: "smlsh-1.0",follow: "smlfw-1.0",recommended: "smlre-1.0",whatsnext: "smlwn-1.0",warning: "smlwrn-1.0",recommendedbox: "smlreb-1.0"}, _8f6 = false;
                                ...
                                _d1.append(function() {
                                    for (var _8f7 in _8ea) {
                                        if (_8ea.hasOwnProperty(_8f7)) {
                                            var _8f8 = _a.util.select(_8f7), _8f9 = {};
                                            if (_8f8.length) {
                                                _8f9[_8ea[_8f7]] = true;
                                                _8f9.pi = false;
                                                _6.layers(_8f9);
                ...
                _a.api.register({context: _6.sharecounters,methods: {getShareCounts: {resources: [{name: "counter",url: _atc.rsrcs.counter,test: function() {
                                        return _6.sharecounters.ost === 1;
                                    }}],callback: function() {
                                _6.sharecounters.getShareCounts.apply(_6.sharecounters, arguments);
                            }}}});
                var _8fa = [{name: "countercss",url: _atc.rsrcs.countercss}, {name: "counter",url: _atc.rsrcs.counter,test: function() {
                            return window.addthis.counter.ost;
                        }}];
                if (_a.bro.ie6 || _a.bro.ie7) {
                    _8fa.push({name: "counterIE67css",url: _atc.rsrcs.counterIE67css});
                }
                if (!w.JSON || !w.JSON.stringify) {
                    _8fa.push({name: "json2",url: _atr + "static/r07/json2.js",test: function() {
                            return w.JSON && w.JSON.stringify;
                        }});
                }
                _a.api.addAsync({method: "counter",resources: _8fa});
                _a.api.addAsync({method: "count",resources: _8fa});
        ...
        (function() {
            ...
            _6.logShare = function(url, _900, _901, _902) {
                var c = _902 || addthis_config, s = _901 || addthis_share;
                c.product = "hdl-" + _a.ver();
                s.imp_url = 0;
                var url = url || (_901 && _901.url) || addthis_share.url, ct = _a.track.dcu(url);
                if (ct.rsc && !_900) {
                    _900 = ct.rsc;
                }
        ...
        _6.user = (function() {
            var a = _a, at = _6, _90c = 1000, u = {}, _90d = 0, _90e = 0, _90f = {tags: a.cookie.tag.get()}, _910 = false, _911 = a.data.OrderedSet, _912 = _a.data.Set, _913;
            ...
            function ready(fn) {
                ...
                if (_90d && (_a.jlng() == "en" || window.addthis_translations)) {
                    var _926 = _a.share.services.init(window.addthis_config), opts = (window.addthis_options || "").replace(",more", "").split(",");
                    if (isOptedOut()) {
                        fn(_90f);
                        return;
                    }
                    ...
                    _a.util.each(a._uss, function(k, name) {
                        _92b.addOne({name: name,score: _6.HIGH});
                    });
                    _a.util.each(a._ssc, function(name, val) {
                        _92b.addOne({name: name,score: val});
                    });
                    _90f.services = _92b;
                    _90f.activity = {};
            ...
            u.getPreferredServices = function(fn) {
                if (_a.jlng() == "en" || window.addthis_translations) {
                    var _932 = _a.share.services.init(window.addthis_config), opts = (window.addthis_options || "").replace(",more", "").split(",");
                    fn(opts);
                } else {
                    _a.ed.addEventListener("addthis.i18n.ready", function() {
                        var _934 = _a.share.services.init(window.addthis_config), opts = (window.addthis_options || "").replace(",more", "").split(",");
                        fn(opts);
                    });
                    _a.alg();
                }
            ...
            function measuredCallFactory(code, _938) {
                var rv = function(a, b, c) {
                    var args = Array.prototype.slice.call(arguments);
                    _a.ed.fire("addthis-internal.api", window.addthis || {}, {call: code});
            ...
            var api = {ready: ready,isReturning: isReturning,isOptedOut: measuredCallFactory("ioo", isOptedOut),isUserOf: measuredCallFactory("iuf", isUserOf),hasInterest: hasInterest,hasTag: hasTag,hasTags: hasTags,isLocatedIn: isLocatedIn,tag: tag,interests: getInterests,services: getServices,location: getLocation};
            _6.session = {source: getSource,isSocial: measuredCallFactory("isl", isSocial),isSearch: measuredCallFactory("ish", isSearch)};
            _a.extend(u, api);
        ...
        if (!window.addthis.osta) {
            ...
            _a.extend(_6, _a.api);
            var d = document, _94d = 0, u = _1, w = window, _94e = {}, _854 = new _a.resource.Resource("widget32css", _atc.rsrcs.widget32css), _94f = new _a.resource.Resource("widget20css", _atc.rsrcs.widget20css), _950 = false, _951 = false, _952, _953, _954, _955, _956 = {}, _957 = {}, body = null, _959 = _a.util.select, _95a = [], _95b = [], _95c = [], v, _95d = {rss: "Subscribe"}, _95e = {tweet: "Tweet",pinterest_share: "Pinterest",email: "Email",mailto: "Email",print: "Print",favorites: "Favorites",twitter: "Tweet",digg: "Digg",more: "View more services"}, json = {email_vars: 1,passthrough: 1,modules: 1,templates: 1,services_custom: 1}, _960 = {feed: 1,more: _a.ver() < 300,email: _a.ver() < 300,mailto: 1}, _961 = {feed: 1,email: _a.ver() < 300,mailto: 1,print: 1,more: !_a.bro.ipa && _a.ver() < 300,favorites: 1}, _962 = {print: 1,favorites: 1,mailto: 1}, _963 = {pinterest_pinit: (_a.ver() < 300),pinterest_share: (_a.ver() < 300)}, _964 = {email: _a.ver() >= 300,more: _a.ver() >= 300};
            ...
            function addIEHoverFix() {
                if (_a.bro.msi && !d.getElementById("at300bhoveriefilter")) {
                    var head = d.getElementsByTagName("head")[0], _96b = d.ce("style"), _96c = d.createTextNode(".at300b:hover,.at300bs:hover {filter:alpha(opacity=80);}");
            ...
            function registerProductCode(o) {
                var opc = (o.parentNode || {}).className || "", pc = o.conf && o.conf.product && opc.indexOf("toolbox") == -1 ? o.conf.product : "tbx" + (o.className.indexOf("32x32") > -1 || opc.indexOf("32x32") > -1 ? "32" : "") + "-" + _a.ver();
                if (pc.indexOf(32) > -1) {
                    _950 = true;
                }
                _a.track.apc(pc);
            ...
            function _parseThirdPartyAttributes(el, _986) {
                var key, attr = [], rv = {}, len = Math.min((el.attributes || []).length || 0, 160), _98b = _986.replace(/:/g, "-");
                if (isNaN(len)) {
                    return rv;
                }
                for (var i = 0; i < len; i++) {
            ...
            function _parseAttributes(el, _98e, name, _990) {
                var _98e = _98e || {}, rv = {}, _992 = _parseThirdPartyAttributes(el, "addthis");
            ...
            function _render(what, conf, _9a2, _9a3) {
                ...
                if (what) {
                    conf = conf || {};
                    _9a2 = _9a2 || {};
                    var _9a4 = conf.conf || _952, _9a5 = conf.share || _953, _9a6 = _9a2.onmouseover, _9a7 = _9a2.onmouseout, _9a8 = _9a2.onclick, _9a9 = _9a2.internal, u = _1, ss = _9a2.singleservice;
                    if (ss) {
                        if (_9a8 === u) {
                    ...
                    for (var i = 0; i < what.length; i++) {
                        var o = what[i], _9c3 = o.parentNode, _9c4 = _getATtributes(o, _9a4, _9a5, !_9a3) || {};
                        mrg(_9c4.conf, _952);
                        mrg(_9c4.share, _953);
                        o.conf = _9c4.conf;
                        o.share = _9c4.share;
                        ...
                        if (o.tagName.toLowerCase() == "a") {
                            ...
                            _a.usu(url);
                            if (ss) {
                                var _9c9 = _getCustomService(ss, o.conf), cbtn = o.firstChild;
                                ...
                                if (!_961[ss]) {
                                    if (_9a2.follow) {
                                        if (ss != "twitter") {
                                            ...
                                            o.href = "http://twitter.com/" + o.share.userid;
                                        }
                                        o.conf = (o.conf || {});
                                        o.conf.follow = true;
                                        ...
                                        if (_a.share.externEvents(ss, o, _9a2)) {
                                        } else {
                                            if (!o.noh) {
                        ...
                        switch (_9a9) {
                            case "img":
                                if (!o.hasChildNodes()) {
                                    var lang = (o.conf.ui_language || _a.lng()).split("-").shift(), _9d3 = _a.ivl(lang);
                                    if (!_9d3) {
                                        lang = "en";
                                    } else {
                                        if (_9d3 !== 1) {
            ...
            function _renderPreferredItem(b, _9d5, _9d6, _9d7, _9d8, _9d9, _9da) {
                ...
                var _9db, excl, sv, _9de, c = b.className || "", _9e0, opts, _9e2 = {pinterest: "pinterest_share"};
                if (!_954) {
                    _954 = 1;
            ...
            function _renderToolbox(_9e5, _9e6, _9e7, _9e8, _9e9) {
                for (var i = 0; i < _9e5.length; i++) {
                    var b = _9e5[i], d = document;
                    if (b == null) {
                        continue;
                    }
                    if (_9e8 !== false || !b.ost) {
                        var attr = _getATtributes(b, _9e6, _9e7, !_9e9), hc = 0, c = b.className || "", _9ef = "", s = c.match(/addthis_button_([\w\-\.]+)(?:\s|$)/), cArr = c.match(/addthis_counter_([\w\.]+)(?:\s|$)/), _9f2 = {}, sv = s && s.length ? s[1] : 0, csv = cArr && cArr.length ? cArr[1] : 0, _9f5 = _getCustomService(sv);
                        mrg(attr.conf, _952);
                        mrg(attr.share, _953);
                        if (sv && !_a.share.extern(sv, b, attr)) {
                            ...
                            if (csv) {
                                ...
                                _render(_9fe, attr, {singleservice: csv});
            ...
            function gat(s, au, conf, _a03) {
                ...
                conf = conf || {};
                var _a04 = conf.data_ga_tracker, _a05 = conf.data_ga_property;
                if (_a05) {
                ...
                if (_a04 && typeof (_a04) == "object") {
                    ...
                    var _a07 = au || (_a03 || {}).url || location.href, _a08 = s, _a09 = "share";
                    if (_a08.indexOf("_") > -1) {
                        _a08 = _a08.split("_");
                        _a09 = _a08.pop();
                        if (_a09.length <= 2) {
            ...
            _6.update = function(_a0a, what, _a0c) {
                if (_a0a == "share") {
                    ...
                    for (var i in _6.links) {
                        var o = _6.links[i], rx = new RegExp("&" + what + "=(.*)&"), ns = "&" + what + "=" + _euc(_a0c) + "&";
            ...
            _6.button = function(what, _a12, _a13) {
                ...
                _render(what, {conf: _a12,share: _a13}, {internal: "img"});
            };
            _6.toolbox = function(what, _a15, _a16, _a17, _a18) {
                var _a19 = _959(what);
                for (var i = 0; i < _a19.length; i++) {
                    var tb = _a19[i], _a1c = window.jQuery, attr = _getATtributes(tb, _a15, _a16, _a17), sp = document.ce("div"), c;
                    tb.services = {};
                    if (tb && tb.className) {
                        ...
                        if (tb.className.indexOf("floating_style") > -1) {
                            ...
                            if (!tb.fixed) {
                                ...
                                var _a24 = dce("DIV", "at-floatingbar-inner"), _a16 = dce("DIV", "at-floatingbar-share"), _a25 = dce("DIV", "addthis_internal_container");
